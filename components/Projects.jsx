    ...
    return (
        <Box sx={{ my: 2 }}>
            <Paper elevation={2} sx={{ mb: 2 }} >
                <Typography variant="h6" component={'div'} sx={{ fontWeight: 400, p: 1, pb: 0 }} >With Orgranization</Typography>
                <AccordionPanel
                    icon={NUHS_Icon}
            ...
            <Paper elevation={2} sx={{ mt: 2 }}>
                ...
                <Box sx={{ display: 'flex', p: 1, cursor: 'pointer' }} onClick={() => window.open('https://medium.com/@jian_ming/tracking-telegram-users-location-18333ee21b32')}>
                    <Box sx={{ flexGrow: 1 }}>
                        <Typography variant='body1' sx={{ pt: 1 }} >{`Tracking Telegram User's Location`}</Typography>
               ...
               The article also explains how this point specific location data can be collected over time to create time-series visualizations of a Telegram user's movements.`}</Typography>
                    ...
                    <Box width={120} height={120} minWidth={120} >
                        <Image width={120} height={120} placeholder="blur" src={Telegram_Medium} />
                    </Box>
                ...
                <Box sx={{ display: 'flex', p: 1, cursor: 'pointer' }} onClick={() => window.open('https://medium.com/@jian_ming/crypto-com-nft-bot-tutorial-7978b68e04b1')}>
                    <Box sx={{ flexGrow: 1 }}>
                        <Typography variant='body1' sx={{ pt: 1 }} >{`Crypto.com NFT Marketplace Bot Tutorial`}</Typography>
                    ...
                    <Box width={120} height={120} minWidth={120} >
                        <Image width={120} height={120} src={NFT_Medium} placeholder="blur" />
                    </Box>
                </Box>
            </Paper >
            ...
            <Paper elevation={2} sx={{ mt: 2 }}>
                ...
                <Box sx={{ display: 'flex', p: 1 }}>
                    <Box sx={{ flexGrow: 1 }}>
                        <Typography variant='body1' sx={{ pt: 1 }} >{`Singapore Bus Timings`}</Typography>
                    ...
                    <Box width={120} height={120} minWidth={120} >
                        <Image width={120} height={120} src={BusTiming_App} placeholder="blur" />
                    </Box>
                ...
                <Box sx={{ display: 'flex', p: 1, cursor: 'pointer' }} onClick={() => window.open('https://play.google.com/store/apps/details?id=com.jayam.singaporespeedlimit')}>
                    <Box sx={{ flexGrow: 1 }}>
                        <Typography variant='body1' sx={{ pt: 1 }} >{`Singapore Speed Limit`}</Typography>
                    ...
                    <Box width={120} height={120} minWidth={120} >
                        <Image width={120} height={120} src={SpeedLimit_App} placeholder="blur" />
                    </Box>
                </Box>
